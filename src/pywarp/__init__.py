...
def warp10read(sc, endpoint, token, selector, end, timespan, conf = None):
  """
...
"""
  ...
  df = df.select('`gts.class`', '`gts.labels`', '`gts.attributes`', 'datapoint.ts', 'datapoint.lat', 'datapoint.lon', 'datapoint.elev', 'datapoint.l_value', 'datapoint.d_value', 'datapoint.b_value', 'datapoint.s_value','datapoint.bin_value')
